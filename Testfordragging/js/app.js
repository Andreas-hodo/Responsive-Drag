class DragDrop{
   ...
   Dragstart(dragId,callback){
    ...
    this.draggablestate = this.drag_btn.draggable
    this.drag_btn.draggable = false
    console.log(this.drag_btn.draggable)
        if(this.drag_btn.classList.contains(this.draggablelabel)){
    ...
    if(this.drag_btn.classList.contains(this.dragId) && this.drag_btn.classList.contains(this.draggablelabel)){
         e.preventDefault()       
   ...
   Drop(dropId,callback){
    ...
    this.drag_btn.addEventListener("pointerup",(e)=>{
        ...
        if(this.draggablestate){
          this.drag_btn.draggable = this.draggablestate  
        }       
